...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textView1 = (TextView) findViewById(R.id.location);
        textView2 = (TextView) findViewById(R.id.coordinate);
        textView3 = (TextView) findViewById(R.id.weather);
        textView4 = (TextView) findViewById(R.id.temperature);
        textView5 = (TextView) findViewById(R.id.humidity);
        textView6 = (TextView) findViewById(R.id.sunrise);
        textView7 = (TextView) findViewById(R.id.sunset);
    ...
    private class GetWeather extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... arg0) {
            ...
            Weather_Handler weatherHandler = new Weather_Handler();
